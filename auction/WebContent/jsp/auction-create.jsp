...
<body>
	...
	<div class="container">
		<div class="col-md-12 auction_create_panel">
			<div class="row">
				...
				<div class="auction_create_form col-md-6 col-md-offset-2">
					<form id="create_auction_form" action="FrontController" method="POST" onsubmit="validate(); return false">
