...
<body>
	...
	<div class="container">
        ...
        <div class="col-md-10 col-md-offset-0 auctions_list_type_chooser">
					...
					<div class="text-left">
						<form action="FrontController" method="GET">
							...
							<button type="submit" class="btn">
								<fmt:message bundle="${current_locale}" key="locale.main.all.auctions"/>
							</button>
						</form>
					</div>
				</li>
		...
		<div class="col-md-12 auctions_list_panel">
			<div class="row">
				<c:if test="${requestScope.auctionsInfo != null}">
					...
					<c:if test="${not empty auctions.auctions }">
						<c:forEach items="${auctions.auctions}" var="current">
							<div class="auctions_list_auction">
								<form action="FrontController" method="GET">
									...
									<button type="submit" class="btn btn col-md-10 col-md-offset-1">
										...
										<div id="auctions_list_info" class="col-md-7 col-md-offset-1 text-left">
											<div class="auctions_list_name">
												<span>${current.lot.name }</span>
											</div>
											<div class="auctions_list_type">
												<span class="auctions_list_info_text"><fmt:message bundle="${current_locale}" key="locale.lot.type"/>:</span>
