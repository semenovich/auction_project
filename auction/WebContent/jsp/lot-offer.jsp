...
<body>
	...
	<div class="container">
		...
		<c:if test="${requestScope.isLotDataInvalid != true}">
			<div id="lot_offer_info_invalid_message" style="visibility: hidden; display:inline;">
				<p><fmt:message bundle="${current_locale}" key="locale.lot.info.invalid"/></p>
			</div>
		</c:if>
		<div class="col-md-6 col-md-offset-2 lot_offer_panel">
			<form action="FrontController" method="POST">
				<input type="hidden" name="command" value="OFFER_LOT"/>
				<h2 class="lot_offer_form_heading col-md-offset-2 text-center"><fmt:message bundle="${current_locale}" key="locale.offer.lot"/></h2>
