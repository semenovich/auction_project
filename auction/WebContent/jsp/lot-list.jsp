...
<body>
	...
	<div class="container">
        ...
        <div class="col-md-10 col-md-offset-1 lots_list_type_chooser">
		...
		<div class="col-md-10 col-md-offset-1 lots_list_status_chooser">
			<ul class="nav navbar-nav">
				<li>
		           	<form action="FrontController" method="GET">
        ...
        <div class="col-md-10 col-md-offset-1 lots_list_panel">
