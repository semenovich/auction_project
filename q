...
<body>
	...
	<div class="container">
		...
		<div class="col-md-6 col-md-offset-2 lot_create_panel">
			<form action="FrontController" method="POST">
				<input type="hidden" name="command" value="CREATE_LOT"/>
				<h2 class="lot_create_form_heading col-md-offset-2 text-center"><fmt:message bundle="${current_locale}" key="locale.lot.create"/></h2>
